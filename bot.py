...
2. В "Лучшие находки" включай ТОЛЬКО исходы, где твоя оценка вероятности ≥ 60%.
   Если ни один исход не дотягивает до 60% — честно скажи об этом в блоке находок,
   не занижай порог и не притягивай слабые варианты.
...
[Если подходящих находок меньше трёх или нет совсем — выведи столько, сколько реально есть, и честно об этом скажи]
