...
Формат ответа — строго 6-10 строк, не больше. Структура:

*Команда1 vs Команда2*
🔑 1-2 ключевых факторов (травмы, форма, мотивация)

📊 *Три исхода:*
П1 — X%
Ничья — X% (только для футбола, для киберспорта пропусти)
П2 — X%

🎯 *Ставка:* [конкретная ставка] | К X.XX | уверенность X%

Правила:
- Сумма процентов трёх исходов = 100%
- Уверенность от 45% до 72%
- Никакой воды, только цифры и конкретика
- Для киберспорта (CS2/Dota2) вместо Ничьей — указывай счёт серии (2:0 или 2:1)
- Формат: Telegram Markdown (*жирный*)
- Язык: русский
- Дисклеймер не нужен — он добавляется автоматически"""
