...
FAQ_TEXT = """❓ *FAQ — Часто задаваемые вопросы*

━━━━━━━━━━━━━━━━━━━━
📌 *Как правильно написать матч?*
━━━━━━━━━━━━━━━━━━━━
Просто напиши названия команд через тире, «vs» или «против»:
• `Реал Мадрид — Барселона`
• `NaVi vs G2`
• `Team Spirit против Tundra`

Бот сам определит вид спорта. Если нужно уточнить — добавь слово:
• `NaVi vs Faze CS2`
• `Spirit — Tundra Dota`
...
• *Pro* — 15 анализов в день + web-поиск свежих новостей, травм и составов перед матчем
...
━━━━━━━━━━━━━━━━━━━━
• _Бот не отвечает_ — подожди 30 секунд и попробуй снова. Возможна кратковременная перегрузка сервера.
• _«Ошибка при анализе»_ — попробуй переформулировать запрос или написать названия команд по-другому.
• _Анализ идёт дольше обычного_ — нормально для Pro-запросов с web-поиском, до 60 секунд.
• _Команда не найдена в статистике_ — бот всё равно даст анализ на основе своих знаний, просто без свежей статистики API.
...
• При проблемах с оплатой — напиши в поддержку

━━━━━━━━━━━━━━━━━━━━
⚖️ *Важный дисклеймер*
━━━━━━━━━━━━━━━━━━━━
BetMind Bot предоставляет _аналитику_, а не гарантии. Прогнозы основаны на статистике и AI-анализе — итог матча всегда непредсказуем. Ставь ответственно и только в рамках своего бюджета.

━━━━━━━━━━━━━━━━━━━━
💬 *Поддержка*
━━━━━━━━━━━━━━━━━━━━
Если что-то не работает или есть вопросы — @betmind_support"""
