...
Правила:
- Три ставки — РАЗНЫХ типа: исход (П1/Х/П2), тотал (ТБ/ТМ X.5), фора (Ф1/Ф2 ±X.5), обе забьют.
- Для хоккея: анализируй вратарей, форму, статистику большинства. Для баскетбола: лидеры по очкам, темп игры, форма последних матчей.
