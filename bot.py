...
FAQ_TEXT = (
    ...
    "\n"
    "Или просто пришли скриншот матча из букмекера,\n"
    "Flashscore, Sofascore, HLTV — бот сам всё распознает 📸\n"
    "\n"
    "━━━━━━━━━━━━━━━━━━━━\n"
...
async def analyze_screenshot(image_bytes: bytes, plan: str | None) -> str:
    ...
    user_msg = (
        ...
        "Распознай команды, вид спорта, турнир, коэффициенты если видны. "
        "Затем дай полный профессиональный анализ по стандартной структуре."
    )
...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        try:
            await wait_msg.edit_text("❌ Ошибка при анализе скриншота. Попробуй ещё раз или напиши матч текстом.")
        except Exception:
            pass
