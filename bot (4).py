...
FREE_LIMIT = 10  # запросов всего (не в день) для Free — только футбол
...
FAQ_TEXT = (
    ...
    "━━━━━━━━━━━━━━━━━━━━\n"
    "Free — 10 анализов (только футбол, без подписки)\n"
...
async def show_plans(message):
    text = (
        ...
        "🆓 *Free* — 10 футбольных анализов (всего, без подписки)\n\n"
        ...
        if not plan:
            ...
            if free_left_now == 0:
                ...
                await update.message.reply_text(
                    ...
                    "🔥 Pro — 15 анализов + web-поиск, 799₽/мес",
                    parse_mode=ParseMode.MARKDOWN,
